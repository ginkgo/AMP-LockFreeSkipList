/*
 * StrategyScheduler2PerformanceCounters.h
 *
...
#ifndef STRATEGYSCHEDULER2PERFORMANCECOUNTERS_H_
#define STRATEGYSCHEDULER2PERFORMANCECOUNTERS_H_
...
class StrategyScheduler2PerformanceCounters {
public:
	StrategyScheduler2PerformanceCounters() {}
	StrategyScheduler2PerformanceCounters(StrategyScheduler2PerformanceCounters<Pheet, TaskStoragePerformanceCounters, FinishStackPerformanceCounters>& other)
...
template <class Pheet, class TaskStoragePerformanceCounters, class FinishStackPerformanceCounters>
inline void StrategyScheduler2PerformanceCounters<Pheet, TaskStoragePerformanceCounters, FinishStackPerformanceCounters>::print_headers() {
...
template <class Pheet, class TaskStoragePerformanceCounters, class FinishStackPerformanceCounters>
inline void StrategyScheduler2PerformanceCounters<Pheet, TaskStoragePerformanceCounters, FinishStackPerformanceCounters>::print_values() {
	num_spawns.print("%lu\t");
...
#endif /* STRATEGYSCHEDULER2PERFORMANCECOUNTERS_H_ */
