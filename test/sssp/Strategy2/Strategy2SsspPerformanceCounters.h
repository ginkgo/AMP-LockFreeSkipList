/*
 * Strategy2SsspPerformanceCounters.h
 *
...
#ifndef STRATEGY2SSSPPERFORMANCECOUNTERS_H_
#define STRATEGY2SSSPPERFORMANCECOUNTERS_H_
...
class Strategy2SsspPerformanceCounters {
public:
	typedef Strategy2SsspPerformanceCounters<Pheet> Self;

	Strategy2SsspPerformanceCounters() {}
	Strategy2SsspPerformanceCounters(Self& other)
...
#endif /* STRATEGY2SSSPPERFORMANCECOUNTERS_H_ */
